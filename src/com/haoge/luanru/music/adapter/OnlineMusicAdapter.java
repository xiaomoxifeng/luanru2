...
public class OnlineMusicAdapter extends BaseListAdapter2 {
	/**
	...
	public OnlineMusicAdapter(Context context, List<Music> list,AbsListView lbs) {
		super(context, list);
	...
	public View bindView(int position, View convertView, ViewGroup parent) {
		...
		String url = m.getAlbumpic().getFileUrl(mContext);
